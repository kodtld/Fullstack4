...
describe('total likes', () => {
  ...
  test('when list has multiple blogs equals combined likes', () => {
...
describe('favorite blog', () => {
  ...
  test('when list has multiple blogs, picks the most liked one',() =>{
...
describe('most active author', () => {
  ...
  test('when list has multiple blogs, picks the most reoccuring author',() =>{
